...
function App() {
  ...
  return (
    <div
      className="w-full h-screen flex flex-wrap justify-right items-center bg-cover bg-no-repeat"
      style={{
    ...
    >
      <div className="w-full">
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          <h1 className="bg-blue-600 text-white text-center px-4 py-3 rounded-lg m-2">
            Currency Converter
          </h1>
          <form
            onSubmit={(e) => {
